...
public class FaltantesActivity extends ListActivity {

    public static final String TAG = FaltantesActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            adapter = new AdaptadorBien(FaltantesActivity.this, getBienes(jsonData));
    ...
    private Bien[] getBienes(String jsonData) throws JSONException {
        ...
        JSONArray data = resultado.getJSONArray("bienes_no");
