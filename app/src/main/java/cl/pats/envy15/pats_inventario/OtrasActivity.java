...
public class OtrasActivity extends ListActivity {

    public static final String TAG = OtrasActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            adapter = new AdaptadorBien(OtrasActivity.this, getBienes(jsonData));
    ...
    private Bien[] getBienes(String jsonData) throws JSONException {
        ...
        JSONArray data = resultado.getJSONArray("bienes_otra");
